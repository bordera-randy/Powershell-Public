...
#
#    Description:
#    This script will perform an audit and output a spreadsheet with the details of
#    all accounts. 
#    
#    
#    
...
$lpa=0
$sa=0
$outfile |Export-Csv "c:\temp\$domain-AdaccountAudit-$date1.csv" -NoTypeInformation
